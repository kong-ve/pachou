...
<script>
     import {loginName} from '../../api/auth/login'
     import { setAdminId,getAdminId } from "../../utils/auth"; // 验权
export default {
    data() {
    ...
    methods: {
        handleLogin() {
            this.$refs["ruleForm"].validate(valid => {
                if (valid) {
                    this.loading = true;
                    // console.log(this.ruleForm.userName,this.ruleForm.pwd)
                    let data =  new FormData();
                    data['username']=this.ruleForm.userName;
                data['password']=this.ruleForm.pwd;
                    this.$store
                        .dispatch("loginName", data)
                        .then(response => {
            ...
            return;
                            ...
                            // this.$store.setAdminId(this.ruleForm.userName);
